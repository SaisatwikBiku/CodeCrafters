/**
 * stages.js — Game stage definitions
 * Each stage has tasks for Architect and Builder.
 * expected_output is used for automated pass/fail checking.
 */
window.STAGES = [
  {
    stageNumber: 1,
  ...
  },
  {
    ...
    tasks: {
      Architect: {
        ...
        expected_output: null, // Dynamic — can't statically check input()
      },
      Builder: {
