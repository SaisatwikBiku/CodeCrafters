...
export default function GamePage() {
    ...
    const attachListeners = (socket: any) => {
      ...
      socket.on('partner_status', ({ ready, allReady }: any) => {
        if (ready && !allReady) {
          setMessages((prev) => [
            ...prev,
            { id: uid(), sender: '', message: 'Your partner is ready! Finishing up...', isSystem: true },
          ]);
        }
      });
      ...
      socket.on('player_disconnected', ({ playerName, role }: any) => {
        setMessages((prev) => [
          ...prev,
          { id: uid(), sender: '', message: `⚠️ ${playerName} (${role}) disconnected.`, isSystem: true },
        ]);
      });
    };
  ...
  const handleRun = async () => {
    ...
    try {
      ...
      const passed = task.expected_output === null
      ...
      <main className="game-main">
        ...
        <section className="panel panel-code">
          ...
          <div className="console-wrap">
            <div className={`console ${consoleError ? 'error' : ''}`} style={{ whiteSpace: 'pre-wrap' }}>
              {consoleText}
            </div>
          </div>

          <button className="btn btn-run" disabled={running} onClick={handleRun}>
        ...
        <section className="panel panel-campus">
          ...
          <div className="chat-wrap">
            ...
            <div className="chat-input-row">
              ...
              />
              <button className="btn btn-send" onClick={sendChat}>Send</button>
            </div>
          </div>
        </section>
      </main>
